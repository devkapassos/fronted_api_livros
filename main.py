    ...
    def home_page():
        ...
        def cadastrar (e):
            data = {
                ...
                'categorias': [] #TODO: Desenvolverem as categorias
            }
        ...
        def avaliar(e):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    page.snack_bar = ft.SnackBar(ft.Text(F'Erro ao enviar avaliação'))                
                
                page.snack_bar.open = True
            
            except Exception as e:
                page.snack_bar = ft.SnackBar(ft.Text('Erro de conexão: {e}'))
                page.snack_bar.open = True
